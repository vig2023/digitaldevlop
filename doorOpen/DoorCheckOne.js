const plugin = ({widgets, simulator}) => {
    ...
    function setRandom() {
        ...
        let ele = document.getElementsByClassName("front")[0];
        ele.style.display='none'
        }else if(val<=40){
            let ele = document.getElementsByClassName("left-one")[0];
            ele.style.display='none'
        }else if(val<=60){
            let ele = document.getElementsByClassName("left-two")[0];
            ele.style.display='none'
        }else if(val<=80){
            let ele = document.getElementsByClassName("right-one")[0];
            ele.style.display='none'
        }else if(val<=100){
            let ele = document.getElementsByClassName("right-two")[0];
            ele.style.display='none'
        }else if(val<=120){
            let ele = document.getElementsByClassName("bannet")[0];
            ele.style.display='none'
        }
...
setInterval(setRandom, 5000);
    ...
    widgets.register("doorcheckone", (box) => {
        boxGlobal = box
