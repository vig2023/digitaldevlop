...
setInterval(setSpeedRandom, 2500);
    widgets.register("demospeedonettTwelve", (box) => {
        const div = document.createElement("div")
...
setInterval(setDistanceRandom, 2500); 
    ...
    widgets.register("distancedemotwottTwelve", (box) => {
        const div = document.createElement("div")
        div.style = "display: flex;height: 100%;width: 100%;"
    ...
    widgets.register("distanceMapTwelve", (box) => {
        const div = document.createElement("div")
        div.style = "display: flex;height: 100%;width: 100%;"
    ...
    //CT-Car-Placement
    widgets.register("ctcardisplayTwelve", (box) => {
        const div = document.createElement("div")
        div.style = "display: flex;height: 100%;width: 100%;"
    ...
    //eof CT-car
     //CT-Car-Placement
     widgets.register("ctMobileDisplayTwelve", (box) => {
        const div = document.createElement("div")
        div.style = "display: flex;height: 100%;width: 100%;"
