...
const plugin = ({widgets, simulator, vehicle}) => {
    ...
    function setSpeedRandom() {
        // console.log()
            ...
            speedStatusDiv.querySelector(`.speedVal span`).textContent = trVal
...
setInterval(setSpeedRandom, 2500);
    ...
    function setDistanceRandom() {
        ...
        // var element=container.querySelector(".status-text");
        distanceStatusDiv.querySelector(`.distanceVal span`).textContent = trDistanceVal
...
// setInterval(setDistanceRandom, 2500); 
    ...
    // widgets.register("distancedemotwottDemoModel", (box) => {
    //     const div = document.createElement("div")
    //     div.style = "display: flex;height: 100%;width: 100%;"
