...
const plugin = ({widgets, simulator, vehicle}) => {
    ...
    function setSpeedRandom() {
        ...
        console.log(speedStatusDiv,"Vigneshh")
        // var element=container.querySelector(".status-text");
        speedStatusDiv.querySelector(".spaVal").textContent = trVal
    ...
    widgets.register("demospeedonettApp", (box) => {
        ...
        * {
        ...
        <div style="font-size: 9em;line-height: 1.5em;text-align:center">
            <div class="speedVal" data-cell="speed-stat" style="color:#383c7f;font-weight:bolder"><strong> </strong><span class="spaVal">29</span></div>
...
setInterval(setDistanceRandom, 2500); 
    ...
    widgets.register("distancedemotwottApp", (box) => {
        ...
        * {
        ...
        <div style="display: flex;flex-direction: column;width: 100%;height: 100%;padding: 30px 40px;justify-content: center;color: #808080;user-select: none;background-color: #f7f7f7;">
        <div style="display: flex;/* align-items:center; *//* justify-content: center; */margin-bottom: 30px;">
        <img src="https://firebasestorage.googleapis.com/v0/b/digital-auto.appspot.com/o/media%2Fdistance.png?alt=media&amp;token=d965e8c2-edc4-416c-8312-9e88264d9fda" style="height: 100%;width: 32%;object-fit: cover;">               
        </div>
        <div style="font-size: 1em; line-height: 1.5em;">
            ...
            <div class="mode" data-cell="mode-drive"><strong>Driving Mode: </strong><span></span></div>
        </div>
    </div>
        `
