...
setInterval(setSpeedRandom, 2500);
    widgets.register("demospeedonettEight", (box) => {
        const div = document.createElement("div")
...
setInterval(setDistanceRandom, 2500); 
    ...
    widgets.register("distancedemotwottEight", (box) => {
        const div = document.createElement("div")
        div.style = "display: flex;height: 100%;width: 100%;"
    ...
    //CT-Car-Placement
    widgets.register("ctcardisplayEight", (box) => {
        const div = document.createElement("div")
        div.style = "display: flex;height: 100%;width: 100%;"
    ...
    //eof CT-car
     //CT-Car-Placement
     widgets.register("ctMobileDisplayEight", (box) => {
        const div = document.createElement("div")
        div.style = "display: flex;height: 100%;width: 100%;"
