const plugin = ({widgets, simulator}) => {
    ...
    <div style="max-width: fit-content; margin: 0 auto; position: relative; margin: auto 0;">
        ...
        <p>Front Left: <span style="color:red;font-family: 'Lato'">14 psi</span></p>
        <p>Front Right: <span style="color:#1973a5;font-family: 'Lato'">40 psi</span></p>
        </div>
        <div style="display:flex">
        <p>Rear Left: <span style="color:#1973a5;font-family: 'Lato'">40 psi</span></p>
        <p>Rear Right: <span style="color:#1973a5;font-family: 'Lato'">40 psi</span></p>
        </div>
        </div>
    </div>
    `)
