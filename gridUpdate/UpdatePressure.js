const plugin = ({widgets, simulator}) => {
    ...
    container.innerHTML = (`
    <div style="max-width: fit-content;position: relative; margin: auto;">
        ...
        <p>F_Left: <span style="color:red;font-family: 'Lato';font-size:12px;font-weight:800">14 psi</span></p>
        <p>F_Right: <span style="color:#1973a5;font-family: 'Lato';font-size:12px;font-weight:800">40 psi</span></p>
        </div>
        <div style="display:block">
        <p>R_Left: <span style="color:#1973a5;font-family: 'Lato';font-size:12px;font-weight:800">40 psi</span></p>
        <p>R_Right: <span style="color:#1973a5;font-family: 'Lato';font-size:12px;font-weight:800">40 psi</span></p>
        </div>
        </div>
    </div>
    `)
    ...
    widgets.register("uppressure", (box) => {
        boxGlobal = box
